    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          {/* _________ PAYMENT METHOD SELCETION __________ */}
          <div className='flex gap-3 flex-col '>
            <div onClick={()=>setMethod('stripe')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border flex rounded-full ${method === 'stripe' ? 'bg-green-400' : ''}`}></p>
        ...
        <p>Dummy stripe card number:4242424242424242 </p>
